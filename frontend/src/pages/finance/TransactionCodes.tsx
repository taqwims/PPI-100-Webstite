                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                {showAddCategory ? (
                                    <div className="space-y-1.5 p-3 bg-green-50/70 border border-green-200 rounded-xl">
                                        <label className="text-xs text-green-900 font-semibold block">Tambah Kategori Baru</label>
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-3 py-1.5 bg-white border border-green-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500"
                                                autoFocus
                                            />
                                            <button
                                                type="button"
                                            ...
                                            <button
                                                ...
                                                className="px-2.5 py-1.5 border border-slate-200 bg-white text-slate-600 rounded-lg text-xs hover:bg-slate-50 transition"
                                            >
                                                Batal
                                            </button>
                                        </div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm bg-white"
                                        required
                                    >
                                        <option value="">-- Pilih Kategori (Ditentukan Admin) --</option>
                                        {categoryOptions.map(cat => (
                                            <option key={cat} value={cat}>{cat}</option>
                                        ))}
                                        {canEdit && (
                                            <option value="__NEW__" className="text-green-600 font-bold">
