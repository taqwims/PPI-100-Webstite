        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-600">Data kehadiran siswa</p>
                </div>
            </div>
                ...
                <TableGlass>
                    ...
                    <TableBodyGlass>
                        {isLoading ? (
                            ...
                            <TableRowGlass>
                                <TableCellGlass colSpan={4} className="text-center py-8 text-slate-600">Belum ada data absensi.</TableCellGlass>
                            </TableRowGlass>
                        ) : (
                            attendances?.map((att: Attendance) => (
                                <TableRowGlass key={att.id}>
                                    ...
                                    <TableCellGlass>
                                        <span className="font-medium text-slate-900">{att.schedule.subject.name}</span>
                                    </TableCellGlass>
                                    <TableCellGlass>
                                        <div className="flex items-center gap-2 text-slate-600">
                                            <Clock size={14} />
