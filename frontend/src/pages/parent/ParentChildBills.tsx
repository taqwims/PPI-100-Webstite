    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">Tagihan Keuangan</h1>
                    <p className="text-gray-400">Daftar tagihan sekolah</p>
                </div>
            </div>
                ...
                <TableGlass>
                    ...
                    <TableBodyGlass>
                        {isLoading ? (
                            ...
                            <TableRowGlass>
                                <TableCellGlass colSpan={5} className="text-center py-8">Belum ada tagihan.</TableCellGlass>
                            </TableRowGlass>
                        ) : (
                            bills?.map((bill: Bill) => (
                                <TableRowGlass key={bill.id}>
                                    ...
                                    <TableCellGlass>
                                        <span className="text-white">{formatCurrency(bill.amount)}</span>
                                    </TableCellGlass>
                                    <TableCellGlass>
                                        <span className="text-green-400">{formatCurrency(bill.paid_amount)}</span>
                                    </TableCellGlass>
                                    <TableCellGlass>
                                        {bill.status === 'Paid' ? (
