...
const TeacherGrades: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-white">Penilaian Tugas</h1>
                <p className="text-gray-400">Kelola nilai tugas siswa</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 space-y-4">
                    <CardGlass className="p-4">
                        <h3 className="font-bold text-white mb-4">Daftar Tugas</h3>
                            ...
                            <TableGlass>
                                ...
                                <TableBodyGlass>
                                    {isLoadingSubmissions ? (
                                        ...
                                        <TableRowGlass>
                                            <TableCellGlass colSpan={4} className="text-center py-8">Belum ada pengumpulan.</TableCellGlass>
                                        </TableRowGlass>
                                    ) : (
